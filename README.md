...
- **Live Demo:** [Streamlit Cloud 링크](https://smart-korean-food-menu-analyzer-for-foreigners.streamlit.app/)
- **Repository URL:** [GitHub 레포지토리 링크](https://github.com/atieh98/Smart-Korean-Food-menu-analyzer-For-Foreigners.git)
...
```bash
# 1. 레포지토리 클론
git clone [https://github.com/atieh98/Smart-Korean-Food-menu-analyzer-For-Foreigners.git](https://github.com/atieh98/Smart-Korean-Food-menu-analyzer-For-Foreigners.git)
...
*(아래 단계별 구동 화면은 프로젝트 내 `images/` 폴더의 스크린샷을 참조합니다.)*
...
- **OpenAI:** Used for debugging assistance, documentation refinement, and code review.
